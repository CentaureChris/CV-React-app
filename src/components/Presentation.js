        ...
        <div>
            ...
            <div id="carouselExampleFade" className="carousel slide carousel-fade" data-bs-ride="carousel">
                <div className="carousel-inner">
                    ...
                    <img src="images/background.jpeg" className="d-block w-100" alt="..." height="500px"/>
                    </div>
                    <div className="carousel-item">
                    <img src="images/crossfit_caroussel.jpeg" className="d-block w-100" alt="..." height="500px"/>
                    </div>
                    <div className="carousel-item">
                    <img src="images/Tireur-délite.jpeg" className="d-block w-100" alt="..." height="500px"/>
                    </div>
                </div>
            ...
            <section className="row row-cols-1 row-cols-md-2 g-4 m-5" >
            ...
            <div className="card col" >
                        ...
                        <ul className="list-group list-group-flush">
                            ...
                            <li className="list-group-item">Programmation informatique: HTML CSS JavaScript Ajax jQuerry React</li>
                        </ul>
                    </div>
